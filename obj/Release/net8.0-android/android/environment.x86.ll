...
@dso_cache = dso_local local_unnamed_addr global [516 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1080651069, ; hash 0x40696d3d, from name: P2PFil.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1640591521, ; hash 0x61c970a1, from name: aot-P2PFil
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-P2PFil.dll.so
		ptr null; void* handle (0x0)
	}, ; 182
	...
	%struct.DSOCacheEntry {
		i64 1980728699, ; hash 0x760f857b, from name: libaot-P2PFil.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-P2PFil.dll.so
		ptr null; void* handle (0x0)
	}, ; 226
	...
	%struct.DSOCacheEntry {
		i64 2228180035, ; hash 0x84cf5443, from name: P2PFil
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-P2PFil.dll.so
		ptr null; void* handle (0x0)
	}, ; 257
	...
	%struct.DSOCacheEntry {
		i64 2451605235, ; hash 0x922086f3, from name: aot-P2PFil.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-P2PFil.dll.so
		ptr null; void* handle (0x0)
	}, ; 289
	...
	%struct.DSOCacheEntry {
		i64 3825342254, ; hash 0xe402172e, from name: libaot-P2PFil
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-P2PFil.dll.so
		ptr null; void* handle (0x0)
	}, ; 460
